...
export default function Home() {
  ...
  const mintCryptoDevToken = async (amount) => {
    try {
      ...
      await tx.wait();
      setLoading(false);
      window.alert("Sucessfully minted Crypto Wild3 Tokens");
  ...
  return (
    <div>
      <Head>
        <title>Wild3 ICO</title>
        <meta name="description" content="ICO-Wild3" />
        <link rel="icon" href="/favicon.png" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Crypto Wild3 ICO!</h1>
          <div className={styles.description}>
            You can claim or mint Crypto Wild3 tokens here
          </div>
          {walletConnected ? (
            <div>
              <div className={styles.description}>
        ...
        <div>
          <img className={styles.image} src="./cr.jpg" />
        </div>
      </div>

      <footer className={styles.footer}>
      Made with &#10084; by <a href="https://twitter.com/wild3_eth" target="_blank" rel="noreferrer"> Wild3</a>
      </footer>
    </div>
  );
}